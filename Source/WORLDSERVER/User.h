...
public:
	...
	void AddNPCPos(const D3DXVECTOR3& vPos, unsigned long id, unsigned long worldId);
#else
...
#ifdef __ITEMLINK
public:
	void	SendItemLink( CItemElem* pItemElem );
#endif
private:
	u_long	m_idProposer;
#if __VER >= 13 // __COUPLE_1202
...
public:
	void			UpdateUser( CUser* pUser, int nMode );
...
#endif	// __LAYER_1015
	vector<char*>	GetAllUser( CUser* pUser );
