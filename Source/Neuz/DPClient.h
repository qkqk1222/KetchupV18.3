...
public:
	...
	void	SendReqNPCPos(unsigned long dwQuestId);
#else
...
#ifdef __ITEMLINK
	void	SendItemLink( DWORD dwPlayerId, DWORD dwObjId );
	void	OnItemLink( CAr &ar );
#endif

#ifdef __RANDOMOPTION_RETRY
	void	SendRandomOptionRetry(OBJID objItemId, OBJID objItemId2, int nRadio);
#endif
